...
class Encoder(tf.keras.Model):
    ...
    def output_depth(self) -> int:
        return self._enc_layers[0].output_depth
    ...
    def num_heads(self) -> int:
        return self._enc_layers[0].num_heads

    @property
    def key_dim(self) -> int:
        return self._enc_layers[0].key_dim

    @property
    def num_res_layers(self) -> int:
        return self._enc_layers[0].num_res_layers

    @property
    def admin_res_scale(self) -> str:
        return self._enc_layers[0].admin_res_scale

    @property
    def mlp_units(self) -> int:
        return self._enc_layers[0].mlp_units
